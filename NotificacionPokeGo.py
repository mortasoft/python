# -*- coding: utf-8 -*-
#!/usr/bin/python3.5
# Se necesita python-notify
# ejecutar como python3.5 NotificacionPokeGo.py
import gi
import sys
import time,os
...
def leerArchivo():
    try:
        file = open("/home/mario/Desarrollo/po/data/caught-mortasoft@gmail.com.json","r")
        line = file.readlines()
        return line[-1:]
    except:
        return file
...
def monitorear():
    ...
    while True:
        moddate = os.stat("/home/mario/Desarrollo/po/data/caught-mortasoft@gmail.com.json")[8]
